 ...
 */
package se.skltp.adminapplication;
...
@Configuration
@ComponentScan("se.skltp.adminapplication")
...
@PropertySources({
    ...
    @PropertySource(value = "file:${app.conf.dir}/application-config-override.properties", ignoreResourceNotFound = true)
})
