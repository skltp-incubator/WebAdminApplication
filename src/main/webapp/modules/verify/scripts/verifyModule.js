...
angular.module('verifyModule', []).
    controller('verifyCtrl', ['$scope', '$http', '$location', '$interval', 'Restangular', function($scope, $http, $location, $interval, Restangular) {

    console.log("verifyCtrl setup, v7");
